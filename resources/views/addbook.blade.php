            ...
            <div class="max-w-xl w-full space-y-12">
              <div class="lg:text-left text-center">
                ...
                <form class="flex flex-col space-y-8 mt-10">
                 <label class="font-bold text-lg text-white " >Book Name</label> 
                 <input id="bookname" type="text" placeholder="Book Name" class="border rounded-lg py-3 px-3 mt-4 bg-black border-indigo-600 placeholder-white-500 text-white">
