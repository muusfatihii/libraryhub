<template>
    ...
    <div class="w-full overflow-x-auto">
      <table class="w-full">
        ...
        <tbody id="myreadgroups" class="bg-white">
          <ReadingGroupsPanel @showComments="showComments" :idClient="idClient" />
        </tbody>
      </table>
  ...
  <script>
  // @ is an alias to /src
  import ReadingGroupsPanel from '../components/ReadingGroupsPanel.vue'
  import Comment from '../components/Comment.vue'
  
  export default {
    name: 'MyReadingGroupsView',
    data (){
      return{
      idClient:'',
      comment:'',
